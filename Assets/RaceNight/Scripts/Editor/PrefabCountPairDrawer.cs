...
public class PrefabCountPairDrawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        // Calculate rects
        var prefabRect = new Rect(position.x, position.y, 90, position.height);
        var countRect = new Rect(position.x + 95, position.y, 35, position.height);
