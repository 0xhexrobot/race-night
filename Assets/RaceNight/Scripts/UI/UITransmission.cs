...
public class UITransmission : MonoBehaviour {
    ...
    public void setValue(float value) {
        indicator.localPosition = new Vector3(value * (UI_TRANSMISSION_WIDTH - 8.0f) * 0.5f, 0, 0);
    }
    ...
    public void fail() {
        tolerance.GetComponent<Animator>().SetTrigger("fail");
    }

    public void success() {
        tolerance.GetComponent<Animator>().SetTrigger("success");
    }
